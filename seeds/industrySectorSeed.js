...
const seedData = [
  ...
  { name: 'accountant_consulting', IndustryId:},
...
const seedIndustries = () => {
  Promise.each(seedData, industrySector => Industry.create(industrySector));
};

seedIndustries().then(industrySectors =>
  console.log(`Successfully seeded ${industrySectors.length} Industry Sectors.`)
);
